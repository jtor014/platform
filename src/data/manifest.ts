...
export const manifest: PageEntry[] = [
  ...
  },
  {
    ...
    next: '/web-dev/projects/1/build',
  },
  {
    route: '/web-dev/projects/1/build',
    title: 'Build',
    description: 'How the build phase works: direct Claude through tickets, verify each one, and ship.',
    section: 'web-dev',
    navLabel: 'Build',
    navParent: 'Project 1',
    order: 25,
    ...
    next: '/web-dev/projects/1/build/setup',
  },
  {
    route: '/web-dev/projects/1/build/setup',
    title: 'Setup',
    ...
    contentFile: 'projects/project-1/step-by-step-guide.md',
    layout: 'docs',
    prev: '/web-dev/projects/1/build',
    next: '/web-dev/projects/1/build/first-ticket',
  },
  {
    route: '/web-dev/projects/1/build/first-ticket',
    ...
    contentFile: 'projects/project-1/step-by-step-guide.md',
    layout: 'docs',
    prev: '/web-dev/projects/1/build/setup',
    next: '/web-dev/projects/1/build/remaining-tickets',
  },
  {
    route: '/web-dev/projects/1/build/remaining-tickets',
    ...
    contentFile: 'projects/project-1/step-by-step-guide.md',
    layout: 'docs',
    prev: '/web-dev/projects/1/build/first-ticket',
    next: '/web-dev/projects/1/deploy',
  },
  {
    route: '/web-dev/projects/1/deploy',
    title: 'Deploy',
    ...
    contentFile: 'projects/project-1/step-by-step-guide.md',
    layout: 'docs',
    prev: '/web-dev/projects/1/build/remaining-tickets',
    next: '/web-dev/projects/1/client-feedback',
  },
  {
    route: '/web-dev/projects/1/client-feedback',
    title: 'Client Feedback',
    description: 'Show the client, collect feedback, create tickets, and iterate before production.',
    section: 'web-dev',
    navLabel: 'Client feedback',
    navParent: 'Project 1',
    order: 27,
    contentFile: 'projects/project-1/step-by-step-guide.md',
    layout: 'docs',
    prev: '/web-dev/projects/1/deploy',
    next: '/web-dev/projects/1/production',
  },
  {
    route: '/web-dev/projects/1/production',
    title: 'Production',
    description: 'Go live on a custom domain, verify everything, and reflect on the full cycle.',
    section: 'web-dev',
    navLabel: 'Production',
    navParent: 'Project 1',
    order: 28,
    contentFile: 'projects/project-1/step-by-step-guide.md',
    layout: 'docs',
    prev: '/web-dev/projects/1/client-feedback',
  ...
  // === Checkpoint 1 ===
  {
    ...
    layout: 'docs',
    prev: '/web-dev/projects/1/production',
          ...
          children: [
            {
              ...
              children: [
                ...
                {
                  label: 'Build',
                  href: '/web-dev/projects/1/build',
                  children: [
                    { label: 'Setup', href: '/web-dev/projects/1/build/setup' },
                    { label: 'First ticket', href: '/web-dev/projects/1/build/first-ticket' },
                    { label: 'Remaining tickets', href: '/web-dev/projects/1/build/remaining-tickets' },
                  ],
                },
                { label: 'Deploy', href: '/web-dev/projects/1/deploy' },
                { label: 'Client feedback', href: '/web-dev/projects/1/client-feedback' },
                { label: 'Production', href: '/web-dev/projects/1/production' },
              ],
            },
            {
              label: 'Project 2',
