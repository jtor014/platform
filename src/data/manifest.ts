...
export const manifest: PageEntry[] = [
  ...
  },
  {
    ...
    title: 'Build',
    description: 'Direct Claude Code to build the GreenScape website.',
    section: 'web-dev',
    navLabel: 'Build',
    navParent: 'Project 1',
    order: 25,
  ...
  },
  {
    ...
    title: 'Setup',
    description: 'Open VS Code, launch Claude, create the project repo.',
    section: 'web-dev',
    navLabel: 'Setup',
    navParent: 'Build',
    order: 25.1,
  ...
  },
  {
    ...
    description: 'Work through Tickets 3–7 with verification guidance per ticket.',
    section: 'web-dev',
    ...
    next: '/web-dev/projects/1/build/finishing',
  },
  {
    route: '/web-dev/projects/1/build/finishing',
    title: 'Finishing',
    description: 'Deploy, hosting, custom domains, and reflection.',
    section: 'web-dev',
    navLabel: 'Finishing',
    navParent: 'Build',
    order: 25.4,
              ...
              children: [
                ...
                { label: 'Backlog', href: '/web-dev/projects/1/backlog' },
                {
                  ...
                  children: [
                    ...
                    { label: 'Finishing', href: '/web-dev/projects/1/build/finishing' },
                  ],
                },
              ],
            },
