...
export const manifest: PageEntry[] = [
  ...
  // === Projects Landing ===
  {
    ...
    title: 'Projects',
    description: 'The process every project follows: Requirements → Design → Architecture → Implement → Test → Deploy → UAT → Monitor.',
    section: 'web-dev',
    navLabel: 'Projects',
    navParent: 'Web Development',
    order: 19,
  ...
  },
  {
    ...
    description: 'Show the client, collect feedback, create tickets, and iterate before go-live.',
    section: 'web-dev',
    navLabel: 'UAT',
    navParent: 'Project 1',
    order: 27,
